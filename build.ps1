...
#!/usr/bin/env pwsh
# .SYNOPSIS
#   cliHelper.predictor buildScript v1.0
# .DESCRIPTION
#   A custom build script for the module cliHelper.predictor
# .LINK
#   https://github.com/alainQtec/cliHelper.predictor/blob/main/build.ps1
# .EXAMPLE
#   ./build.ps1 -Task Test
